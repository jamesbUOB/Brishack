...
class Fox(Animal):
    ...
    def update(self):
        ...
        self.health_bar.update_colors(new_full_colour=arcade.color.RED)
...
class IndicatorBar:
    ...
    def update_colors(
        self,
        new_full_colour: arcade.color = None,
        new_background_colour: arcade.color = None
    ) -> None:
        """Update the colors of the indicator bar"""
        if new_full_colour:
            self._full_box.color = new_full_colour
        if new_background_colour:
            self._background_box.color = new_background_colour
    ...
    def fullness(self, new_fullness: float) -> None:
        ...
        # Check if new_fullness is valid
